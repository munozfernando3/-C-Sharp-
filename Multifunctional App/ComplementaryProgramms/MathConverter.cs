...
namespace MathConverter // Note: actual namespace depends on the project name.
{
    public  class Converter
    {
        static void MainConverter()
        {
            while (true)
            {
                int userchoice = FirstMenu();
                Console.Clear();
                switch (userchoice)
                {
                    case 1:
        ...
        static int FirstMenu()
        {
            while (true)
            {
                try
                {
                    ...
                    Write("What conversion you would like to do?: ");
        ...
        public static float ConvertYardtoFeet2(float number)
        {
            float measurement = number * 3;
            return measurement;
        }
